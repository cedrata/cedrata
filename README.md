<h2 align="left">Hi 👋! My name is cedrata and I'm a software developer, from italy</h2>
...
With a close frinend of mine I'm also working on some templates for all kinds of projects, you can check them out [here](https://github.com/ReadyCodeToUse):)</p>

###

<p align="left">I recently started to make some templates to help myself with operations that can be repetitive and keep some docs about them. My idea is to keep them as public repos and give the opportunity to make donations for the projects you are interested in if you think they can be useful to you too. If a template become's interesting the development can be kept up to date and improved when issues are open or new features required by you!<br><br>You can visit my ko-fi page here if interested.</p>
...
<p align="left">My frameworks and libraries</p>
...
<p align="left">My code versioning</p>
